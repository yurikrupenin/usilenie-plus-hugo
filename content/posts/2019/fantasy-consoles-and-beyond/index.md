...
Что такое фэнтези-консоль? Само название передаёт общую концепцию, но углубимся в детали: это обычно исключительно программная (работающая на вполне бытовых компьютерах) платформа, имеющая жёсткие искусственные ограничения по производительности, доступным средствам разработки, объёму памяти, цветовой палитре и разрешению экрана... по чему угодно, словом.
