...
{{<map id="tourunite2018-map" anchor="day01" caption="клик! карта!">}}
...
Как известно, единственная большая проблема, чем укладка сумок, в велотуризме только одна — опоздать на электричку, поэтому остановимся на этом моменте поподробнее.
